...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B1oU_9JR.mjs");
...
var manifest = { "7efecebece339662411ed713b9036700cc9cddc6c36c3da0264101774b8b4400": {
	functionName: "getLofiLiveStreams_createServerFn_handler",
	importer: () => import("./lofi-streams-uzaNI52o.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B085E_oT.mjs").then((n) => n.t),
